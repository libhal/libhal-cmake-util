# libhal-cmake-util v4 (Deprecated)

> [!WARNING]
> **DEPRECATED:** This API is deprecated. Please migrate to v5 which uses
> explicit `find_package(LibhalBuild)` integration. See the
> [root README](../README.md) for the new API.
